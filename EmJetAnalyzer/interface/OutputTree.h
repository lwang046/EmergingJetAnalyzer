...
namespace emjet
{
  ...
  public:
    ...
    vector<vector<int> >    trackref_index               ;
    vector<vector<int> >    trackref_jet_index           ;
    vector<vector<float> >  trackref_pt                  ;
    vector<vector<float> >  trackref_eta                 ;
    vector<vector<float> >  trackref_phi                 ;
...
emjet::OutputTree::Init() {
  ...
  trackref_index               .clear();
  trackref_jet_index           .clear();
  trackref_pt                  .clear();
  trackref_eta                 .clear();
  trackref_phi                 .clear();
  vertex_index               .clear();
...
#define BRANCH(tree, branch) (tree)->Branch(#branch, &branch);
  ...
  BRANCH(tree, trackref_index               );
  BRANCH(tree, trackref_jet_index           );
  BRANCH(tree, trackref_pt                  );
  BRANCH(tree, trackref_eta                 );
  BRANCH(tree, trackref_phi                 );
