...
# this is for Gamma +Jet MC samples. Photon Pt cut has been changed to 30GeV
#   for fake rate check

jobname = 'Analysis-20170301'        # Jobname
psetname = 'Configuration/test/test_cfg.py'      # Path to pset
postfix = 'v3'                # Postfix to job, increment for each major version
dryrun = 0
