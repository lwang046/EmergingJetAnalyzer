...
# this is for another set of Gamma +Jet MC samples. For jet scan
#   fake rate check

jobname = 'Analysis-20170413'        # Jobname
psetname = 'Configuration/test/testscan_cfg.py'      # Path to pset
postfix = 'v9'                # Postfix to job, increment for each major version
dryrun = 0
...
datasets = [
    ...
    #dataset( "GJet_Pt-15ToInf" , "/GJet_Pt-15ToInf_TuneCUETP8M1_13TeV-pythia8/RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1/AODSIM" , MC, 1, 1000, splitting='FileBased', priority=30, label='gjet' ), 
    ...
    #dataset( "GJets_HT-600ToInf_RunIIFall15DR76" , "/GJets_HT-600ToInf_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1/AODSIM" , MC, 1, 1000, splitting='FileBased', priority=30, label='gjet' ),
    dataset( "GJets_HT-400To600_RunIIFall15DR76" , "/GJets_HT-400To600_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1/AODSIM" , MC, 1, 100, splitting='FileBased', priority=30, label='gjet' ),
    #dataset( "GJets_HT-200To400_RunIIFall15DR76" , "/GJets_HT-200To400_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1/AODSIM" , MC, 1, 1000, splitting='FileBased', priority=30, label='gjet' ),
    #dataset( "GJets_HT-100To200_RunIIFall15DR76" , "/GJets_HT-100To200_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1/AODSIM" , MC, 1, 1000, splitting='FileBased', priority=30, label='gjet' ),
    #dataset( "GJets_HT-40To100_RunIIFall15DR76" , "/GJets_HT-40To100_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1/AODSIM" , MC, 1, 1000, splitting='FileBased', priority=30, label='gjet' ),
    #dataset( "GJet_Pt-15To6000-Flat" , "/GJet_Pt-15To6000_TuneCUETP8M1-Flat_13TeV_pythia8/RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1/AODSIM" , MC, 1, 1000, splitting='FileBased', priority=30, label='gjet' ),
]
...
if __name__ == '__main__':
    ...
    for dataset in datasets:
        ...
        config.Data.outLFNDirBase = '/store/user/yofeng/GJet/ntuple/%s-%s/pT35To90/%s/' % (jobname, postfix, alias)
