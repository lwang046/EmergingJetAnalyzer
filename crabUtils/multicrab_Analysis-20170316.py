...
# this is for W +Jet MC samples. Apply the W Pt cut (35<pT<90 GeV)
#   for fake rate check

jobname = 'Analysis-20170316'        # Jobname
...
if __name__ == '__main__':
    ...
    for dataset in datasets:
        ...
        config.Data.outLFNDirBase = '/store/user/yofeng/WJet/ntuple/%s-%s/%s/' % (jobname, postfix, alias)
