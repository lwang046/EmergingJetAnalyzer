...
# this is for another set of Gamma +Jet MC samples. Photon Pt cut has been changed to 50GeV for 
#   fake rate check

jobname = 'Analysis-20170308'        # Jobname
psetname = 'Configuration/test/test_cfg.py'      # Path to pset
postfix = 'v4'                # Postfix to job, increment for each major version
dryrun = 0
...
datasets = [
    ...
    dataset( "GJet_Pt-15To6000-Flat_PhotonPtcut50" , "/GJet_Pt-15To6000_TuneCUETP8M1-Flat_13TeV_pythia8/RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1/AODSIM" , MC, 1, 1000, splitting='FileBased', priority=30, label='gjet' ),
