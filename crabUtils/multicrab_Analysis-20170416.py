...
jobname = 'Analysis-20170416'        # Jobname
psetname = 'Configuration/test/test_cfg.py'      # Path to pset
postfix = 'v11'                # Postfix to job, increment for each major version
dryrun = 0
...
datasets = [
    ...
    dataset( "GJets_HT-400To600_RunIIFall15DR76" , "/GJets_HT-400To600_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1/AODSIM" , MC, 1, 1000, splitting='FileBased', priority=30, label='gjet' ),
