...
# this is for another set of Gamma +Jet MC samples. Photon Pt cut has been changed to [35, 90]GeV
#   fake rate check

jobname = 'Analysis-20170321'        # Jobname
psetname = 'Configuration/test/test_cfg.py'      # Path to pset
postfix = 'v8'                # Postfix to job, increment for each major version
dryrun = 0
